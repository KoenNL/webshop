    ...
    <div class="col-md-10 product-result-container">
        <div class="row">
            <div class="col-md-3 col-sm-12 product-overview-box">
                <a href="/product/product" title="Cars Jeans Baggy">
                    <img class="product-image" src="images/Product%20jeans.jpg">
                </a>
                <div class="product-description">
                    <h3 class="product-brand">
                        <a href="/product/product" title="Cars Jeans Baggy">Cars</a>
                    </h3>
                    <p class="product-title">
                        <a href="/product/product" title="Cars Jeans Baggy">Jeans Baggy <span
            ...
            <div class="col-md-3 col-sm-12 product-overview-box">
                ...
                <div class="product-description">
                    <h3 class="product-brand">
                        <a href="/product/product" title="Cars Jeans Baggy">Legendary</a>
                    </h3>
                    <p class="product-title">
                        <a href="/product/product" title="Cars Jeans Baggy">T-shirt <span class="product-price">&euro; 39,95</span></a>
                    </p>
                </div>
            </div>
            <div class="col-md-3 col-sm-12 product-overview-box">
                ...
                <div class="product-description">
                    <h3 class="product-brand">
                        <a href="/product/product" title="Cars Jeans Baggy">Vingino</a>
                    </h3>
                    <p class="product-title">
                        <a href="/product/product" title="Cars Jeans Baggy">Jeans Baggy <span
                                class="product-price">&euro; 79,95</span></a>
