        ...
        <table class="table table-hover shopping-cart">
            ...
            <?php foreach ($order->getOrderLines() as $orderLine) :
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control change-order-line-amount" value="<?php echo $orderLine->getAmount(); ?>"
                    ...
                    <td>
                        <button class="btn btn-default btn-sm remove-order-line" data-id-variation="<?php echo $orderLine->getProduct()->getSelectedVariation()->getIdVariation(); ?>">
